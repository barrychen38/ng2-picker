...
export class AppComponent {
  ...
  private location$: ISubscription;
  private movie$: ISubscription;
  ...
  constructor(
    ...
    this.location$ = this.getData('location.json').subscribe((locations) => {
    ...
    // store movies data
    this.movie$ = this.getData('movie.json').subscribe((movies) => {
  ...
  activePicker(type: number) {
    ...
    this.selectIndex = this.selectIndexs[type];
  ...
  onSelect(value: SendData) {
    ...
    this.selectIndexs[this.type] = selectedIndex;
